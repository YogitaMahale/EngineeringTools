...
public partial class EZACUSfollowup : System.Web.UI.Page
{
    ...
    //  string con2="Provider=Microsoft.ACE.OLEDB.12.0;Data Source=data source=" + Server.MapPath("~/images/uploads/ImportServices/") + fileName +";Extended Properties='Excel 8.0;HDR=YES";
    ...
    {
        string selectquery = "SELECT [PKId],[Name],[Mobile],[City],[IsRead],[Remark], CustomerType, Product, EnquiryFrom FROM EZACUSTblFollowup where [IsRead]=0";
