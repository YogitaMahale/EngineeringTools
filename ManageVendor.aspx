<%@ Page Title="" Language="C#" MasterPageFile="~/morya.master" AutoEventWireup="true" CodeFile="ManageVendor.aspx.cs" Inherits="ManageVendor" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <div class="row">
                ...
                <asp:Button ID="Button1" runat="server" Text="Add New Vendor" CssClass="btn btn-danger" OnClick="btnAddNew_Click" />
                            ...
                            <ItemTemplate>
                                <tr>
                                    <td style="text-align: center">
                                        <asp:Label ID="lblAgentId" runat="server" Visible="false" Text='<%# Eval("vid") %>'></asp:Label>
