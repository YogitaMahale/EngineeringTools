<%@ Page Title="" Language="C#" MasterPageFile="~/morya.master" AutoEventWireup="true" CodeFile="Manage_expenseMaster.aspx.cs" Inherits="Manage_expenseMaster" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
      ...
      <%--<div style="overflow-x: auto;">--%>
                <table id="tblCategory" class="display table table-hover table-striped table-bordered">
                    ...
                    <tbody>
                        <asp:Repeater ID="repExpenseMaster" runat="server" OnItemDataBound="repCategory_ItemDataBound">
                            <ItemTemplate>
                                <tr>
                                     
                                    <td style="text-align: center">
                                        <asp:Label ID="lblExpenseId" runat="server" Visible="false" Text='<%# Eval("eid") %>'></asp:Label>
