<%@ Page Title="" Language="C#" MasterPageFile="~/morya.master" AutoEventWireup="true" CodeFile="managepurchaseorder.aspx.cs" Inherits="managepurchaseorder" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        ...
                        <asp:Button ID="btnpo" runat="server" Text="RAISE PO" class="btn btn-block btn-flickr" Width="150" OnClick="btnpo_Click" /><div class="btn-flickr"></div>
                            ...
                            <table id="tblOrders" class="table table-bordered table-striped">
                                ...
                                <asp:DropDownList ID="ddlSeqNo" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlSeqNo_SelectedIndexChanged" />
                                                ...
                                                <td style="text-align: center">
                                                     <asp:Label ID="lblPO" runat="server" Text='<%# Eval("PONo") %>'></asp:Label>
                                                ...
                                                <td style="text-align: center">
                                                     <%--<asp:Button ID="btnView" runat="server" OnClick="btnView_Click" CommandArgument ='<%#Eval("PurchaseOrderId") %>' CssClass="btn btn-sm btn-success"  Text="View"  ></asp:Button>--%>
                                         &nbsp;&nbsp;<asp:Button ID="btnGRN" runat="server" OnClick="btnGRN_Click" Text="GRN (STOCK IN)" CommandArgument ='<%#Eval("PurchaseOrderId") %>' CssClass="btn btn-sm btn-success" ></asp:Button> <%--OnClick="lnkDelete_Click"--%>
                                         &nbsp;&nbsp;<asp:Button ID="btnDownload" runat="server" OnClick="btnDownload_Click" Text="Download PDF" CommandArgument ='<%#Eval("PurchaseOrderId") %>' CssClass="btn btn-sm btn-success" ></asp:Button>
                                            <%--&nbsp;&nbsp;<asp:Label ID="lblDownload" runat ="server" ><a href="uploads/PurchaseOrders/<%# Eval("PONo") %>.pdf" class="btn btn-sm btn-dropbox" target="_blank" >VIEW</a></asp:Label>--%>
                                                </td>
        ...
        <Triggers><asp:PostBackTrigger ControlID="repOrders"/>  </Triggers>
