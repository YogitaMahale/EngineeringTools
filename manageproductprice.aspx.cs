...
public partial class manageproductprice : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            hPageTitle.InnerText = "Manage Products Price";
            Page.Title = "Manage Product Price";
        }
        if (!Page.IsPostBack)
        {
    ...
    {
        Response.Redirect(Page.ResolveUrl("~/addeditproduct.aspx?page=price"));
    }
    ...
    protected void repProduct_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        if ((e.Item.ItemType == ListItemType.Item) || (e.Item.ItemType == ListItemType.AlternatingItem))
        {
            ...
            hlEdit.NavigateUrl = Page.ResolveUrl("~/addeditproduct.aspx?page=price&id=" + ocommon.Encrypt(DataBinder.Eval(e.Item.DataItem, "pid").ToString(), true));
            hlAddImageVideo.NavigateUrl = Page.ResolveUrl("~/addeditproductmultipleimages.aspx?page=price&id=" + ocommon.Encrypt(DataBinder.Eval(e.Item.DataItem, "pid").ToString(), true));
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        foreach (RepeaterItem item in repProduct.Items)
        {
            ...
            if (chkContainer.Checked)
            {
                ...
                Product_UpdateProductPriceOnly(Convert.ToInt64(ProductId), Convert.ToDecimal(txtCustomerPrice.Text), Convert.ToDecimal(txtDealerPrice.Text), Convert.ToDecimal(txtGST.Text), chbIsStock.Checked, chbIsActive.Checked);
            }
        }
        spnMessage.Visible = true;
        spnMessage.Style.Add("color", "green");
    ...
    public void Product_UpdateProductPriceOnly(Int64 ProductId, decimal CustomerPrice, decimal DealerPrice, decimal GST, bool IsStock, bool IsActive)
    {
        ...
        try
        {
            ...
            cmd.CommandText = "product_UpdateProductPriceOnly";
