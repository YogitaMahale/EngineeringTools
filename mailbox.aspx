<%@ Page Title="" Language="C#" MasterPageFile="~/morya.master" AutoEventWireup="true" CodeFile="mailbox.aspx.cs" Inherits="mailbox" %>
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td style="text-align: center">
                                                    ...
                                                    <span class="body" style="display: none"><%# Eval("Body") %></span>
                                                </td>
                                                <td style="text-align: center">
                                                    <asp:Label ID="lblDate" runat="server" Text='<%# Eval("DateSent") %>'></asp:Label>
...
<script type="text/javascript">
    //$("repCategory").on("click", "lnkView", function () {
