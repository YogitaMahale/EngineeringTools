...
public partial class Report_ProductLedger : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            hPageTitle.InnerText = "Product Ledger";
            //GetLowStockProduct();
        }
    ...
    private void BindDataIntoRepeater(DataTable dtData)
    {
        ...
        repProductLedger.DataSource = null;
        repProductLedger.DataBind();
        // Bind data into repeater
        repProductLedger.DataSource = _pgsource;
        repProductLedger.DataBind();
    ...
    public void search()
    {
        ...
        try
        {
            ...
            cmd.CommandText = "ReportPaging_ProductLedger";
    ...
    protected void btnpdf_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            paragraph1.Add("------------------------------------------------------------------");
            paragraph1.Add("\n");
            paragraph1.Add("Higest Product Selling:");
            paragraph1.Add("\n");
            paragraph1.Add("------------------------------------------------------------------");
            ...
            table.SetWidths(new float[] {1f,9f,1f,1f, 2f });
            table.AddCell("sr");
            table.AddCell("Name");
            table.AddCell("Real Stock");
            table.AddCell("Landing Price");
            table.AddCell("Total");
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                try
                {
                    ...
                    table.AddCell(dt.Rows[i]["RealStock"].ToString());
                    table.AddCell(dt.Rows[i]["LandingPrice"].ToString());
            ...
            DownloadPDF(mstr, "Product Ledger");
