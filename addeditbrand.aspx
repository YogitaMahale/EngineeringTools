        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                  ...
                  <div class="col-xs-6">
                        <label for="exampleInputEmail1" runat="server">Type Name<span style="color:red">*</span> </label>
                        <asp:DropDownList ID="ddlTypeList" runat="server" CssClass="form-control"></asp:DropDownList>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" Display="Dynamic" ControlToValidate="ddlTypeList" CssClass="error" ErrorMessage="Required Field" ValidationGroup="c1"></asp:RequiredFieldValidator>
                    ...
                    <div class="form-group row">
                        ...
                        <asp:TextBox ID="txtBrandName" CssClass="form-control" runat="server"></asp:TextBox></td>
                        <asp:RequiredFieldValidator ID="RFVtxtCompanyName" runat="server" Display="Dynamic" ControlToValidate="txtBrandName" CssClass="error" ErrorMessage="Required Field" ValidationGroup="c1"></asp:RequiredFieldValidator>
