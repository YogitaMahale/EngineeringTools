...
public partial class Report_SalesReport : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            hPageTitle.InnerText = "Sales Report";
            //GetLowStockProduct();
        }
    ...
    private void BindDataIntoRepeater(DataTable dtData)
    {
        ...
        repSaleReport.DataSource = null;
        repSaleReport.DataBind();
        // Bind data into repeater
        repSaleReport.DataSource = _pgsource;
        repSaleReport.DataBind();
    ...
    public void search()
    {
        ...
        try
        {
            ...
            cmd.CommandText = "ReportPaging_SalesReport";
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.AddWithValue("@from", txt_fromDate.Text.Trim());
            cmd.Parameters.AddWithValue("@to", txt_toDate.Text.Trim());
    ...
    protected void btnpdf_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            paragraph1.Add("------------------------------------------------------------------");
            paragraph1.Add("\n");
            paragraph1.Add(" From Date :"+txt_fromDate.Text );
            paragraph1.Add("\n");
            paragraph1.Add(" To Date :" + txt_toDate.Text);
            //paragraph1.Add("\n");
            ...
            table.SetWidths(new float[] { 1f, 2f, 3f,9f, 2f });
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                try
                {
                    ...
                    table.AddCell(dt.Rows[i]["UserType"].ToString());
