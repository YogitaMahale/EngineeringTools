<%@ Page Title="" Language="C#" MasterPageFile="~/morya.master" AutoEventWireup="true" CodeFile="frm_LowStockProductList.aspx.cs" Inherits="frm_LowStockProductList" %>
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <div class="col-xs-12" style="text-align:right;"> 
                                <asp:TextBox ID="txtSearch" runat="server" class="form-control" AutoPostBack="true" OnTextChanged="txtSearch_TextChanged" Width="200"></asp:TextBox>
                            </div>
                            <br />
                            <table id="example12" class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="text-align: center">Stock Count</th>
                                ...
                                <tbody>
                                    <asp:Repeater ID="repLowStockProductList" runat="server">
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td style="text-align: center">
                                                    <asp:Label ID="Label2" runat="server" Text='<%# Eval("quantites") %>'></asp:Label>
                                                </td>
                                            </tr>
                                        </ItemTemplate>
                                    </asp:Repeater>
