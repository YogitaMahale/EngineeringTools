...
namespace DatabaseLayer
{
    public class Cls_category_db
    {
        ...
        public DataTable SelectAllCategory_byTypeid(Int64 id)
        {
                            ...
                            {
                                {
                                   ...
                                   // objcategory.bankid = Convert.ToInt32(ds.Tables[0].Rows[0]["bankid"]);
                                    objcategory.fk_typeid = Convert.ToInt64(ds.Tables[0].Rows[0]["fk_typeid"]);
                                }
                            }
                        }
                    }
        ...
        public Int64 Insert(category objcategory)
        {
            ...
            try
            {
               ...
               // cmd.Parameters.AddWithValue("@bankid", objcategory.bankid);
                cmd.Parameters.AddWithValue("@fk_typeid", objcategory.fk_typeid);
        ...
        public DataTable LoadTypesForBrand()
        {
            DataTable dt = new DataTable();
            try
            {
                SqlCommand cmd = new SqlCommand("LoadTypesForBrand", ConnectionString);
