...
public partial class Report_HigestProductselling : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            hPageTitle.InnerText = "Higest Product selling";
            //GetLowStockProduct();
        }
    ...
    private void BindDataIntoRepeater(DataTable dtData)
    {
        ...
        repHigestProductselling.DataSource = null;
        repHigestProductselling.DataBind();
        // Bind data into repeater
        repHigestProductselling.DataSource = _pgsource;
        repHigestProductselling.DataBind();
        ...
        try
        {
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                try
                {
                    ...
                    table.AddCell(dt.Rows[i]["ProductCount"].ToString());
                }
                catch (Exception)
                {
                }
          ...
          //  documnent.Add(paragraph2);
            ...
            DownloadPDF(mstr,"HigestProductSelling");
