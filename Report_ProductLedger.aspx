<%@ Page Title="" Language="C#" MasterPageFile="~/morya.master" AutoEventWireup="true" CodeFile="Report_ProductLedger.aspx.cs" Inherits="Report_ProductLedger" %>
                        ...
                        <div class="box-body">
                            ...
                            <div class="col-md-6" style="text-align: right;">
                                  <table>
                                    <tr>
                                        <td>
                                            <asp:Label ID="Label4" runat="server" Width="200"></asp:Label></td>
                                        <td>
                            ...
                            <table id="example12" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <asp:Repeater ID="repProductLedger" runat="server">
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td style="text-align: center">
                                                    <asp:Label ID="Label1" runat="server" Text='<%# Eval("RealStock") %>'></asp:Label>
                                                </td>
                                                <td style="text-align: center">
