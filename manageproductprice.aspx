<%@ Page Title="" Language="C#" MasterPageFile="~/morya.master" AutoEventWireup="true" CodeFile="manageproductprice.aspx.cs" Inherits="manageproductprice" %>
        ...
        <table id="tblProduct" class="display table table-hover table-striped table-bordered">
            <thead>
                <tr class="tableheader">
                    ...
                    <th style="text-align: center">Decler Price</th>
                    <th style="text-align: center; display: none">Discount</th>
                    <th style="text-align: center">GST %</th>
                    <th style="text-align: center; display: none">Stock Quantites</th>
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td style="text-align: center">
                                ...
                                <%--OnCheckedChanged="chbIsStock_CheckedChanged"--%>
                            </td>
                            <td style="text-align: center">
